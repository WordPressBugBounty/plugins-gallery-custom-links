...
if ( !class_exists( 'MeowKit_MGCL_Helpers' ) ) {

  class MeowKit_MGCL_Helpers {
    //public static $version = MeowKit_MGCL_Admin::version;
    ...
    public static function timer_start( $timerName = 'default' ) {
      MeowKit_MGCL_Helpers::$startQueries[ $timerName ] = get_num_queries();
      MeowKit_MGCL_Helpers::$startTimes[ $timerName ] = microtime( true );
    }

    public static function timer_elapsed( $timerName = 'default' ) {
      return microtime( true ) - MeowKit_MGCL_Helpers::$startTimes[ $timerName ];
    }

    public static function timer_log_elapsed( $timerName = 'default' ) {
      $elapsed = MeowKit_MGCL_Helpers::timer_elapsed( $timerName );
      $queries = get_num_queries() - MeowKit_MGCL_Helpers::$startQueries[ $timerName ];
  ...
  // if ( MeowKit_MGCL_Helpers::is_rest() ) {
